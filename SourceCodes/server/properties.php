<?php
// プロパティ諸設定
define('DOMAIN', 'https://empower-util.sakura.ne.jp');
define('CONTENTS_NAME', 'U-Linker');
define('SENDFROM', 'noreply@empower-util.sakura.ne.jp');
...
define('FAVICON_HREF', DOMAIN. '/'. CONTENTS_NAME .'/storage/images/favicon-16x16.png');

$headLinks = '<meta charset="UTF-8">'
  . '<meta name="viewport" content="width=device-width, initial-scale=1.0">'
  . '<title>'.CONTENTS_NAME.'</title>'
